...
$upload_dir = '/bkk/public/uploads/normal/'; // path from base_url to base of upload folder (with start and final /)
// Real server
...
//******************
$var_flag = false;
if ($_SESSION["USER_ROLE"] == "admin") $var_flag = true;
$delete_files	 = $var_flag;
$create_folders	 = TRUE;
$delete_folders	 = $var_flag;
$upload_files	 = TRUE;
$rename_files	 = $var_flag;
$rename_folders	 = $var_flag;
$duplicate_files = TRUE;
$copy_cut_files	 = $var_flag; // for copy/cut files
$copy_cut_dirs	 = $var_flag; // for copy/cut directories
